...
import { Users, Activity, FileCheck, LogOut, Search, UserCheck, UserX, Loader, Calendar } from "lucide-react";
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="text-sm">
                  {isLoading ? (
                    <tr><td colSpan="5" className="py-8 text-center text-gray-500"><Loader className="w-6 h-6 animate-spin mx-auto mb-2" /> Loading users...</td></tr>
                    ...
                    filteredUsers.map((user) => (
                      <tr key={user._id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                        <td className="py-4 font-medium text-dark-gray">{user.name}</td>
